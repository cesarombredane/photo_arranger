...
export interface PhotoItem { id: string; name: string; url: string; naturalWidth: number; naturalHeight: number; templateId: string; crop: Crop; cropValidated: boolean }
